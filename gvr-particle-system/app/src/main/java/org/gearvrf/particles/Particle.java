...
public class Particle extends GVRBehavior
{
    static private long TYPE_PARTICLE = newComponentType(Particle.class);
    ...
    public Particle(GVRContext ctx, float velocity, Vector3f direction)
    {
        super(ctx);
        Velocity = velocity;
        Direction = direction;
